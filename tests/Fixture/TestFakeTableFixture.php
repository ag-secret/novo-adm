...
/**
 * TestFakeTableFixture
 *
 */
class TestFakeTableFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'sex' => ['type' => 'string', 'fixed' => true, 'length' => 2, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        '_constraints' => [
