    ...
    <ul class="top-right">
        ...
        <li class="dropdown link" style="margin: 0 5px 0 15px;">
            <a href="#" data-toggle="dropdown" class="dropdown-toggle profilebox">
                <?= $this->Html->image('MyAdm.profileimg.png') ?>
                <strong>
                    <?= $loggedInUser['name'] ?>
                </strong>
            ...
            <ul class="dropdown-menu dropdown-menu-list dropdown-menu-right">
                <li>
                    <?= $this->Html->link(
                        ...
                        ['plugin' => 'MyAdm', 'controller' => 'Users', 'action' => 'settings', 'prefix' => false],
                        ['escape' => false]
                    ) ?>
                </li>
                <li class="divider"></li>
                <li>
                    <?= $this->Html->link(
                        ...
                        ['controller' => 'Users', 'action' => 'logout', 'plugin' => 'MyAdm', 'prefix' => false],
                        ['escape' => false])
                    ?>
                </li>
            </ul>
