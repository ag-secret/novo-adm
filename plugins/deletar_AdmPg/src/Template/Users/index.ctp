...
<div class="page-header">
    ...
    <?= $this->element('AdmPlugin.Breadcrumb', [
        'bcOptions' => [
            'active' => 'Usuários',
            'children' => [
                [
    ...
    <div class="right">
        <?= $this->Html->link('<span class="fa fa-question"></span> Ajuda', [], ['class' => 'btn btn-default', 'escape' => false]) ?>
        <?= $this->Html->link('<span class="fa fa-plus"></span> Adicionar Usuários', ['action' => 'add'], ['class' => 'btn btn-success', 'escape' => false]) ?>
    </div>
</div>
...
<th class="text-center"><?= $this->Paginator->sort('is_active', 'Status') ?></th>
                    ...
                    <div style="margin-top: 40px;">
                        <?= $this->element('AdmPlugin.Paginator') ?>
                    </div>
                </div>
            </div>
        </div>
